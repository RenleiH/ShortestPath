...
public class Vertex {
     ...
     */
    public Vertex(String name, VertexType type, double latitude, double longitude, int mapRow, int mapCol) {
     ...
     *
     * @return a new Vertex instance with the same attributes and neighbors.
     */
    public Vertex copy() {
        Vertex copy = new Vertex(name, type, latitude, longitude, this.mapRow, this.mapCol);
